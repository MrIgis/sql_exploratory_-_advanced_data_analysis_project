/*
==============================================================================
Script Name : 07_performance_analysis.sql
Purpose     : Evaluate product performance vs averages and prior periods
...
SELECT 
    ...
    current_sales 
        - AVG(current_sales) OVER (PARTITION BY product_name) AS avg_sales_diff,
    CASE 
        ...
        ELSE 'Avg'
    END AS avg_sales_position,
    LAG(current_sales) OVER (PARTITION BY product_name ORDER BY order_year) AS prev_year_sales,
    current_sales 
        - LAG(current_sales) OVER (PARTITION BY product_name ORDER BY order_year) AS sales_change,
    CASE
        WHEN current_sales 
